...
for (def i : 1) {
	...
	username = datalogin.getValue('email', i)

	password = datalogin.getValue('password', i)
	...
	message = driver(findTestObject('Object Repository/Page_Login - My Store/input_Email address_email'))
	
					if (message.equals('There is 1 error					Authentication failed.')) {
						System.out.println('ini salah password')
